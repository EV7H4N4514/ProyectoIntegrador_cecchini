...
public class CEducacion {
    ...
    public ResponseEntity<List<Educacion>>list(){
       final List<Educacion> list = sEducacion.list();
    ...
    public ResponseEntity<?> create(@RequestBody  dtoEducacion dtoedu){
        ...
        if(sEducacion.existByNombreEdu(dtoedu.getNombreEdu())){
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoedu){
        ...
        if(sEducacion.existByNombreEdu(dtoedu.getNombreEdu()) && sEducacion.getByNombreEdu(dtoedu.getNombreEdu()).get().getId() !=id)
            return new ResponseEntity(new Mensaje("Ese dato ya existe"), HttpStatus.BAD_REQUEST);
